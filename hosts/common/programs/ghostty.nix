...

{
  ...
  xdg.configFile."ghostty/config".text = ''
    ...
    # Key Mappings (Converted from your Kitty maps)
    keybind = alt+backspace=text:\x1bd
    keybind = alt+down=scroll_page_down
  ...
  xdg.configFile."ghostty/shaders/blue_embers.glsl".text = ''
    ...
    #define SPARK_COLOR vec3(0.05, 0.45, 1.5) * 1.5
    #define BLOOM_COLOR vec3(0.05, 0.35, 1.0) * 0.8
    #define SMOKE_COLOR vec3(0.1, 0.38, 1.0) * 0.8
