    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: data => {
                ...
                // FIXED: Directing volume digits string color value straight to yellow/base05 instead of white
                var textColor = isMuted ? "red" : ((root && root.theme && root.theme.base05 !== undefined) ? root.theme.base05.toString() : "yellow");
                var tagColor = (root && root.theme && root.theme.base05 !== undefined) ? root.theme.base05.toString() : "yellow";
