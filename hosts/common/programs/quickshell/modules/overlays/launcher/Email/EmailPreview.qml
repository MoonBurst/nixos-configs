...
Rectangle {
    ...
    // Condensed regex linkification formatter
    function formatBodyWithLinks(rawText) {
        return rawText ? rawText.replace(/(https?:\/\/[^\s]+)/g, '<a href="$1">$1</a>') : "";
    }
    ...
    Column {
        ...
        Rectangle {
            ...
            Column {
                ...
                Row {
                    ...
                    Rectangle {
                        width: 150; height: 26; color: previewComp.scrollTrackBg; radius: 4; border.color: previewComp.scrollHandleColor; border.width: 1
        ...
        Item {
            ...
            Flickable {
                ...
                Text {
                    id: textBodyContent; width: parent.width; text: previewComp.formatBodyWithLinks(previewComp.activeMailBodyText !== "" ? previewComp.activeMailBodyText : "Select an email...")
