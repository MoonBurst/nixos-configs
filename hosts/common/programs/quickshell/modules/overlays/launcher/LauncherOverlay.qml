...
// Relative imports to reference your status bar widgets
import "../../bar/cpu"
import "../../bar/gpu"
import "../../bar/ram"
...
Rectangle {
    ...
    /*
     * ROW WRAPPER FOR HORIZONTAL ALIGNMENT
     */
    Row {
        id: layoutContainerRow
        ...
        /*
         * MAIN PANEL (REPOSITIONED TO FIT THE ROW)
         */
        Rectangle {
            id: mainPanel
